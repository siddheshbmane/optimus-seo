        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
            ...
            <div className="col-span-2">
              ...
              <p className="text-text-secondary text-sm mb-4 max-w-xs">
                Your AI SEO team, on autopilot. Automate your SEO operations and
                win more clients.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="/integrations" className="text-sm text-text-secondary hover:text-text-primary">
                    Integrations
                  </Link>
                </li>
                <li>
          ...
          <div className="mt-12 pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-text-muted">
              © 2026 Optimus SEO. All rights reserved.
            </p>
            <p className="text-sm text-text-muted">
